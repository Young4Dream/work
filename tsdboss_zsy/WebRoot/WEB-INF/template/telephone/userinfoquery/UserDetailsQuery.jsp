...
<html>
	<head>
        ...
        function gethwjbtjbz(tfjstatus)
        {
           ...
           var urlstr=tsd.buildParams({  
				 ...
				 ********/ 
				  ...
				  var tjbz = fetchSingleValue("get.HwjbDef",6,"&key="+tfjstatus,'business');
        ...
        /***********************
			...
			* @return;
			...
			function getcusttype(key){
				 ...
				 *************************/
				 function getcusttype(key){
				 var str =  fetchSingleValue("getKHLX",6,"&key="+key,'business');
				return str;
			}
        ...
        ********/       
        ...
        {
           var str = fetchSingleValue("getCT",6,"&key="+key,'business');
			return str;	
        ...
        *@return
        ...
        {
          var str = fetchSingleValue("getBZ",6,"&key="+key,'business');
