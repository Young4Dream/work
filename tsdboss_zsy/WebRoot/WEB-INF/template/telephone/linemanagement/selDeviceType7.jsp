<%----------------------------------------
	name: selDeviceType.jsp
	author: youhongyu
	version: 1.0, 2011-6-8
	description: 对号线设备类型的管理
	modify:
		2011-6-16 youhongyu 显示设备模块信息用视图数据量太大显示太慢，改用sql语句
---------------------------------------------%>
...
<%
	...
	String deviceno_p = request.getParameter("deviceno");
%>
<%
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="script/telephone/linemanagement/selDeviceType.js" type="text/javascript"></script>	
...
<style type="text/css">		
	#left_k{width:175px;height:360px;float:left;clear:both;overflow-x:scroll;border:1px solid #99ccff;}	
	#right_k{width:500px;height:360px;float:right;overflow-x:hidden;border:1px solid #99ccff;}		
</style>
  </head>
  ...
  <body>
	...
	<div id="right_k">
		<div style="height: 35px;padding-top: 7px;">
			...
			-->
			<label>模块名称：</label><input type="text" id="TwoDeviceName" nodeid="" nodename="" pnodename="" style="width: 75px;"/>
	...
	<input type="hidden" id="deviceno_P" value="<%=deviceno_p %>" />
