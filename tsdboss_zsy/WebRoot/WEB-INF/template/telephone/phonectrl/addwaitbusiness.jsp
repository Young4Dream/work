<%----------------------------------------
	...
	description: 添加调级业务
	modify: 
		2011-4-19 youhongyu 单表编辑更新，需同步
---------------------------------------------%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<!-- 本页面特殊使用 -->
		<script src="script/telephone/phonectrl/addwaitbusiness.js" type="text/javascript"></script>
...
jQuery(document).ready(function () {	
		...
		***************************************/
		...
		$("#newbusinetitle").hide();
		$("#newbusinecsnum").hide();
		$("#newbusinetitle_two").hide();
		$("#newbusinecsnum_two").hide();
		$("#newbusinetitle_three").hide();
		$("#newbusinecsnum_three").hide();
		//自动添加用户分类费
		$("#dhnewbusines_key").change(function(){
			var flf = $("#dhnewbusines_key option:selected").attr("flf");
			if(flf==undefined||flf=="undefined"||flf==""){
					...
					$("#newbusinetitle_two").show();
					$("#newbusinecsnum_two").show();
					$("#newbusinetitle").show();
					$("#newbusinecsnum").show();
					$("#newbusinetitle_three").hide();
					$("#newbusinecsnum_three").hide();
					...
					$("#newbusinetitle_two").show();
					$("#newbusinecsnum_two").show();
					$("#newbusinetitle_three").show();
					$("#newbusinecsnum_three").show();
			}else{
					$("#newbusinetitle").hide();
					$("#newbusinecsnum").hide();
					$("#newbusinetitle_two").hide();
			...
			/*
			if($("#dhnewbusines_key").val()!=""){
				$("#hcdhgn_key").val("");
			}*/
			$("#newbusinecsnum_three").val("");
			$("#newbusinecsnum").val("");
			$("#newbusinecsnum_two").val("");
		});
		/*
		$("#hcdhgn_key").change(function(){
			if($("#hcdhgn_key").val()!=""){
				$("#dhnewbusines_key").val("");
				$("#newbusinecsnum").val("");
				$("#newbusinetitle").hide();
				$("#newbusinecsnum").hide();
				...
				<table width="100%" id="addtable" border="0" cellspacing="0" cellpadding="0" style="line-height:33px; font-size:12px;">			
					 ...
					 <tr>
				 	  ...
				 	  <tr>
						...
						<td width="220px" align="left" style="border-bottom:1px solid #A9C8D9;">
							<input type="text" id="valuekey" name="valuekey" style='width:180px'/>
						</td>	
				 	  </tr>
				 	 <tr>
						    <td width="120px" align="right" class="labelclass"><label id="servicetypeg_a">电话功能</label></td>							
						    <td width="220px" align="left" style="border-bottom:1px solid #A9C8D9;">    	
						    	<select name="hcdhgn_key" id="hcdhgn_key" class="textclass">
						    		<option value="">--<fmt:message key="global.select"/>--</option>
						    	</select>
						    </td>
						    <td width="120px" align="right" class="labelclass"><label id="servicetypeg_a">新业务</label></td>							
						    <td width="220px" align="left" style="border-bottom:1px solid #A9C8D9;">						    	
						    	<select name="dhnewbusines_key" id="dhnewbusines_key" class="textclass">
						    		<option value="">--<fmt:message key="global.select"/>--</option>
						    	</select>						    	
						    </td>
				 	 </tr>
				 	 <tr>
						    <td width="120px" align="right" class="labelclass"><label id="servicetypeg_a">新业务办理类型</label></td>							
						    <td width="220px" align="left" style="border-bottom:1px solid #A9C8D9;">						    	
						    	<select name="newbusinetype" id="newbusinetype" class="textclass">
						    		<option value="">--<fmt:message key="global.select"/>--</option>
						    		<option value="1">开通</option>
						    		<option value="0">取消</option>
						    	</select>						    	
						    </td>
						    <td width="120px" align="right" class="labelclass"><label id="newbusinetitle">新业务参数1</label></td>							
						    <td width="220px" align="left" style="border-bottom:1px solid #A9C8D9;">
								<input type="text" id="newbusinecsnum" name="newbusinecsnum" style='width:180px'/>
							</td>					
				 	 </tr>
				 	 <tr>
						    <td width="120px" align="right" class="labelclass"><label id="newbusinetitle_two">新业务参数2</label></td>							
						    <td width="220px" align="left" style="border-bottom:1px solid #A9C8D9;">
								<input type="text" id="newbusinecsnum_two" name="newbusinecsnum_two" style='width:180px'/>
							</td>	
							<td width="120px" align="right" class="labelclass"><label id="newbusinetitle_three">新业务参数3</label></td>							
						    <td width="220px" align="left" style="border-bottom:1px solid #A9C8D9;">
								<input type="text" id="newbusinecsnum_three" name="newbusinecsnum_three" style='width:180px'/>
							</td>					
				 	 </tr>
				 	 <tr>
				 	 	<td colspan=4><center><font style="color:red">新业务办理类型（开通/取消）操作只针对只新业务，不针对电话功能</font></center></td>
				 	 </tr>
			 	   </tboby>
				</table>
			</form>	
