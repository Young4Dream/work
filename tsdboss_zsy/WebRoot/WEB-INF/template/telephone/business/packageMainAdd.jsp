...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$(function(){
		...
		$.ajax({
			...
			success:function(res){
				var packageTypes = res.split("/*/")[0];
				var packageBuses = res.split("/*/")[1];
				var gifts = res.split("/*/")[2];
				var salePolicys = res.split("/*/")[3];
		        ...
		        $.each(salePolicys, function(i, item) {
					...
					$("#rateSalePolicySub").append("<option value="+item.id+">"+item.saleName+"</option>");
		        });
					...
					$(xml).find('row').each(function(){
						$(xml).find('cell').each(function(){
							if($(this).text() == '0'){
								...
								var subServiceType = $("#sub_service_type").val();
								
								var url = 'packageMainServlet.html';
								$.ajax({
									url:url,
									data:'cmd='+5+"&packageName="+packageName+"&packageType="+packageType+"&packageFee="+packageFee+"&pagFreeNum="+pagFreeNum+
										"&packageStatus="+packageStatus+"&gid="+gid+"&remark="+remark+"&serviceType="+serviceType+"&subServiceType="+subServiceType+"&operaotr=1&json1="+json1,
									datatype:'html',
									type:'post',
									cache:false,
									timeout: 1000,
	...
	function addrate_oper()
	{
		//套餐业务id
	 	...
	 	//计费基本单位数量
	 	var bnUnitNum = $.trim($("#bnUnitNum").val());
	 	//计费基本单位显示值
	 	var bnUnitValue = $.trim($("#bnUnitValue").val());
	 	//费率阶梯阀值
...
<body style="background-color:#F4FCFE;"> 
	<div id="navBar">
		...
		: 套餐管理 >>> <a href="#" onclick="turnToMainPage();">套餐管理</a>	 >>> 新增
			...
			<fieldset class="fieldset" style="width: 997px;">
				...
				<table border="0"  style="width: 90%;">
					...
					<tr bgcolor="" align="center" height="27">
						...
						<td align="left">
							<select id="service_type" name="service_type" style="width:136px;margin-left:0px;">
						...
						<td align="left">
							<select id="sub_service_type" name="sub_service_type" style="width:136:px;margin-left:0px;">
								<option value="">--请选择--</option>
								<option value="E1">E1</option>
								<option value="光芯">光芯</option>
								<option value="管孔">管孔</option>
				...
				<div id="addrate_div"
					...
					<fieldset id="addrate_panel" class="fieldset" style="width:963px;">
						<legend style="font-size: 13px; color:#000000;margin-left:15px;">
							<b>添加套餐业务费率</b>
						</legend>
						<table border="0">
							<tr height="29">
							...
							<tr>
								...
								<td align="left">
									<select id="rateSalePolicy" name="rateSalePolicySub" style="width:136px;margin-left:0px;">
									<option value="-1">--请选择--</option>
								</select>
								</td>
				...
				<div id="buttons" style="background:url(); border-top:0px; border-bottom:0px;">
					<!-- 提交 -->
					<button type='button' class="module_btn" id="form_submit">
						提交
					</button>
					<!-- 重置 -->
					<button  type='button' onclick="resetMtd();">
						重置
					</button>
				</div>
			</fieldset>
