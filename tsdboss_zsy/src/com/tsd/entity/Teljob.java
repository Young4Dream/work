...
public class Teljob implements java.io.Serializable {
	...
	private String zwbz;
	private int oldservicearea;
	private double zjfee;
	private double yjfee;
	private double gjfee;
	...
	/** minimal constructor */
	public Teljob(int id, Date sgrq, String iscomplete, String jobstatus,
			int reprinttimesofsf) {
		this.id = id;
		this.sgrq = sgrq;
	...
	/** full constructor */
	public Teljob(int id, String lsh, String cardid, String xdh, String ydh,
			String area, String beginywarea, String ywarea, String hth,
			String yhth, int typeid, int idd, String sgnr, String bz,
			...
			int reprinttimesofjob, String zwbz, int oldservicearea,
			double zjfee, double yjfee, double gjfee) {
		this.id = id;
		this.lsh = lsh;
		this.cardid = cardid;
		this.xdh = xdh;
		...
		this.zwbz = zwbz;
		this.oldservicearea = oldservicearea;
		this.zjfee = zjfee;
		this.yjfee = yjfee;
		this.gjfee = gjfee;
	}
	...
	public int getOldservicearea() {
		return this.oldservicearea;
	}

	public void setOldservicearea(int oldservicearea) {
		this.oldservicearea = oldservicearea;
	}
	...
	public void setYjfee(double yjfee) {
		this.yjfee = yjfee;
	}

	public double getGjfee() {
		return this.gjfee;
	}

	public void setGjfee(double gjfee) {
		this.gjfee = gjfee;
	}

	@Override
	public String toString() {
		return "Teljob [id=" + id + ", lsh=" + lsh + ", cardid=" + cardid
				+ ", xdh=" + xdh + ", ydh=" + ydh + ", area=" + area
				+ ", beginywarea=" + beginywarea + ", ywarea=" + ywarea
				+ ", hth=" + hth + ", yhth=" + yhth + ", typeid=" + typeid
				+ ", idd=" + idd + ", sgnr=" + sgnr + ", bz=" + bz + ", sgrq="
				+ sgrq + ", dhlx=" + dhlx + ", jlry=" + jlry + ", xm=" + xm
				+ ", nxm=" + nxm + ", bm1=" + bm1 + ", bm2=" + bm2 + ", bm3="
				+ bm3 + ", bm4=" + bm4 + ", yhxz=" + yhxz + ", zw=" + zw
				+ ", xdz=" + xdz + ", ydz=" + ydz + ", zjlx=" + zjlx
				+ ", dhgn=" + dhgn + ", linkman=" + linkman + ", lxdh=" + lxdh
				+ ", gzlx=" + gzlx + ", wxbz=" + wxbz + ", wxry=" + wxry
				+ ", yjkx=" + yjkx + ", yjje=" + yjje + ", slbm=" + slbm
				+ ", ispay=" + ispay + ", pgrq=" + pgrq + ", mqbm=" + mqbm
				+ ", jsbm=" + jsbm + ", pxggbj=" + pxggbj + ", chggbj="
				+ chggbj + ", jfggbj=" + jfggbj + ", pgrz=" + pgrz + ", wgrq="
				+ wgrq + ", wgbm=" + wgbm + ", iscomplete=" + iscomplete
				+ ", modual=" + modual + ", port=" + port + ", typenum="
				+ typenum + ", sjje=" + sjje + ", payFlag=" + payFlag
				+ ", value1=" + value1 + ", value2=" + value2 + ", value3="
				+ value3 + ", value4=" + value4 + ", value5=" + value5
				+ ", value6=" + value6 + ", value7=" + value7 + ", value8="
				+ value8 + ", value9=" + value9 + ", value10=" + value10
				+ ", value11=" + value11 + ", value12=" + value12
				+ ", value13=" + value13 + ", value14=" + value14
				+ ", value15=" + value15 + ", value16=" + value16
				+ ", value17=" + value17 + ", value18=" + value18
				+ ", value19=" + value19 + ", value20=" + value20
				+ ", ifcancel=" + ifcancel + ", isjudge=" + isjudge
				+ ", djhwcsj=" + djhwcsj + ", djhswc=" + djhswc + ", mobile="
				+ mobile + ", jiaofeidh=" + jiaofeidh + ", jobstatus="
				+ jobstatus + ", ifurgent=" + ifurgent + ", reprinttimesofsf="
				+ reprinttimesofsf + ", reprinttimesofjob=" + reprinttimesofjob
				+ ", zwbz=" + zwbz + ", oldservicearea=" + oldservicearea
				+ ", zjfee=" + zjfee + ", yjfee=" + yjfee + ", gjfee=" + gjfee
				+ "]";
	}
