<%----------------------------------------
	...
	modify: 
		2010-12-13　youhongyu fck图片上传不了问题更正
		2010-12-13  youhongyu 显示详细中有undefined信息;用户名不显示;双击不显示详细问题更正
---------------------------------------------%>
...
jQuery(document).ready(function () 
{
    ...
    jQuery("#editgrid").jqGrid(
    {
        ...
        loadComplete : function ()
        {
        	...
        	if(ids != null) {
				var nid =$("#editgrid").getCell(ids,"nid");
				readMemo(nid);
			}
        }	
    }).navGrid('#pagered', {
