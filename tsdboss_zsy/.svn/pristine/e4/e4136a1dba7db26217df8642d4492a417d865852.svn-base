...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<!-- 收费结账专用js -->
	<script src="script/telephone/charge/charge_phone_all.jsp" type="text/javascript"></script>
     ...
     if((key < 48||key > 57) && key != 46 ){
       ...
       if(key == 46){
		...
		function searchInfo(){
			...
			var key=$("#ghSearchBox").val();
			if(key.indexOf("10001")>-1){
     	...
     	<div id="gh" align="left" >
			<div id="ghBar" style="margin-left: 10px;">
				<table style="margin-top: 5px">
					<tr valign="middle">
						<td>
							&nbsp;&nbsp;<span style="font-size: 14px;font-weight: bold;">客户号</span><!-- 电话号码: -->
						</td>
						<td>
			...
			<div id="ghFP">
					<hr width="67%" style="height:1px;border:none;border-top:1px dashed #0066CC;" />
				<!-- 多合同号缴费时，显示多合同号 -->
				<div id="multiHths"></div>
				<table id="ghInfo" style="display:none"></table>
				<jsp:include page="rev_bill_all.jsp"></jsp:include><!-- 实时余额：  元 -->
				<div id="ghYHYE" style="width: 100%;" tip1="<fmt:message key="charge_phone.RealTimeBalance"/>" tip2="<fmt:message key="charge_phone.InTheCurrent"/>"><!-- 当前月费用：  元 -->
					<br />
					<hr width="66%" style="height:1px;border:none;border-top:1px dashed #0066CC;" />
				</div>
			</div>
			...
			<div id="ghButtons" style="text-align: center;">
				...
				<div>
					...
					<button class="tsdbtn" id="ghsave" style="width: 80px;" disabled="disabled" onclick="onSaves();">
						<fmt:message key="charge_phone.save"/><!-- 保存 -->
					</button>
					<span style="visibility: hidden;">__</span>
					<button class="tsdbtn" style="width: 80px;" onclick="clearAll();">
