...
//设置Y精度
//myChart.setAxisValuesNumberY(2000);
...
function printReport(basePath,rptName){
  ...
  <body >
	...
	<div id="sIn" style="margin-top: 0;font-size: 14px">
		&nbsp;&nbsp;
		<fmt:message key="Onduty.timesFrom" />：<!-- 时间范围 -->
		<input type="text" class="textclass" name="tBegin" id="tBegin" style="width: 160px;height: 22px;line-height: 22px;margin-left: 0px" onFocus="WdatePicker({startDate:'%y-%M-%d 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
		...
		<button id="dutybuttons" class="btn" onclick="printReport('<%=basePath %>','pDuty')" style="display: none">
	...
	<hr size="1" noshade="noshade" style="border:1px #A9C8D9 dotted;"/>	
  	...
  	<br/>
  	<label style="font-size: 14px;font-weight: bold;margin-left: 5px"><fmt:message key="duty_new.jscharts"/>：</label>
