...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>    
	...
	<style type="text/css">
		...
		#left_k{width:170px;height:330px;float:left;clear:both;overflow-x:scroll;border:1px solid #99ccff;}	
		#right_k{width:525px;height:330px;float:right;overflow-x:hidden;border:1px solid #99ccff;}
