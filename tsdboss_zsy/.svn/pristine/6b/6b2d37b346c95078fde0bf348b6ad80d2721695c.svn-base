...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>    
	...
	$(function(){
		//见装机页面填写的标头放到空号选好权限中		
		var nhead = parseUrl(document.location.search,"kdHead","");
		$("#kgquery").val(nhead);		
		Dat = loadData("rad_hmzy","zh",2);
		getData();
		...
		$("#choose").click(function(){
			...
			if(selidx!=null)
			{
				var radacc = $("#editgrid").getCell(selidx,"RADACCOUNT");		
				window.dialogArguments.setAcc(radacc);				
				window.close();
			}
			else
			{
		...
		**********/
		function getRefresh(){
			var params = $("#params").val();		
				...
				var khquerynew = "kdHead="+$("#kgquery").val()+"&";
				var khqueryold = "kdHead="+$("#kgqueryold").val()+"&";
			...
			<div id="bottom_t">
			  <ul>
					<li>
						...
						<input type="text" style="width:200px" id="kgquery"/>
					</li>					
					<li>
