...
public class WorkFlowServlet_bk extends HttpServlet {

	private static final long serialVersionUID = 1L;
	/**
	 * Constructor of the object.
	 */
	public WorkFlowServlet_bk() {
		super();
	}
	public void destroy() {
		super.destroy();
		...
		try {
			...
			while(rs.next()){
				...
				*/
				...
				//System.out.println("JobType: "+sJobType);
			...
			if(flag){
				...
				//拼接工单显示信息
				tbinfo += "<table id=\"ntable\" width=\"100%\" style=\"border: 1px; border-style: solid; border-color: #87CEFA;text-align:center\" cellpadding=\"2px\" cellspacing=\"1px\">";
				tbinfo += "<tr style=\"background-color: #c0c0c0\">";
				tbTitle += "<th class=\"jobtabclass\">序号</th><th class=\"jobtabclass\">类型</th><th class=\"jobtabclass\">状态</th>";
				tbTitle += "<th class=\"jobtabclass\">详细</th><th class=\"jobtabclass\">用户账号</th><th class=\"jobtabclass\">受理人员</th>";
				tbTitle += "<th class=\"jobtabclass\">派工人员</th><th class=\"jobtabclass\">所属区域</th><th class=\"jobtabclass\">目前区域</th>";
				tbTitle += "<th class=\"jobtabclass\">当前部门</th><th class=\"jobtabclass\">用户姓名</th>";
	            if("p_changename".equals(sYwlx) || "transfer".equals(sYwlx)){						//电话更名 宽带过户
	            	tbTitle += "<th class=\"jobtabclass\">原姓名</th>";
	            }
	            tbTitle += "<th class=\"jobtabclass\">用户地址</th>";
	            if("p_movephone".equals(sYwlx) || "move".equals(sYwlx)){							//电话移机 宽带移机
	            	tbTitle += "<th class=\"jobtabclass\">原地址</th>";
	            }
	            tbTitle += "<th class=\"jobtabclass\">部门超时</th><th class=\"jobtabclass\">工单超时</th></tr>";
