			...
			<div id="broadband_frame">
			   <div id="inputtext">
				...
				<table style="background-color:#A9C8D9;border:#A9C8D9 solid 0px;">
					<tr>
						<th width="180"><center><h4><fmt:message key="phone.getinternet0100" /><!-- 合同号 --></h4></center></th>
						<th width="120"><center><h4><fmt:message key="phone.getinternet0103" /><!-- 电话 --></h4></center></th>
						<th width="300"><center><h4>部门名称</h4></center></th></tr>
				</table>					
