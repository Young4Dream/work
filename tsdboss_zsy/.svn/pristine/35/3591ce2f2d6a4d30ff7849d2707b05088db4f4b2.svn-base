...
<!-- jqgrid面板显示 -->			
	...
	<div id="sumpan" style="width: 700px;">								
			<table id="listSumTb" cellspacing="2px;" cellpadding="0" 
				style="width: 680px;border: 0px;float:left;">
...
<div class="neirong" id="pan" style="display: none;width: 700px;">
	...
	<div class="top">
	    ...
	    <!-- 取消     --><button class="tsdbutton" id="reset" style="width:63px;heigth:27px;" onclick="resett();"><fmt:message key="publicLable.Cancel" /></button>
...
<div style="display: none">
	...
	<input type="hidden" id="inputModifyField" value="<fmt:message key='SingleTabE.inputModifyField'/>" />
