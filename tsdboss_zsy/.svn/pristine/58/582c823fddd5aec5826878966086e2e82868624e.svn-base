			   ...
			   <div id="inputtext">
				<table id="xzhthselect" cellspacing="4">
					<tr>
						...
						<td>
							<button id="hthselect" class="tsdbutton" onClick="selecthth('0');" 
				...
				<table style="background-color:#A9C8D9;border:#A9C8D9 solid 0px;">
					<tr><th width="180"><center><h4><fmt:message key="phone.getinternet0100" /><!-- 合同号 --></h4></center></th><th width="120"><center><h4><fmt:message key="phone.getinternet0103" /><!-- 电话 --></h4></center></th><th width="300"><center><h4><fmt:message key="phone.getinternet0104" /><!-- 名称 --></h4></center></th></tr>
				</table>					
