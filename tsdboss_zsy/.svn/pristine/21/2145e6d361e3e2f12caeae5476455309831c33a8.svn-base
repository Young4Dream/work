...
/************************************** 尤红玉 **************************************************/
	...
	<body>
		<div id="body-panel"  style="border:0px solid #000">
			<div id="menu-panel" style="border:0px solid #F00;position:absolute;"></div>
		</div>
		<div id="float-panel">
			<div id="nav-bar">
				<!-- 返回 -->
			...
			<div id="menu-manage-panel">
				<form id="menu-manage-form" name="menuManageForm" onsubmit="return false;">
					<!-- 管理菜单项 -->
					<h4 id="mmf-title"><fmt:message key="menuManager.manageMenu" /><fmt:message key="menuManager.manageMenu" /></h4>
					<table>
					<tr>
...
<!-- 添加模板面板 -->
<div id="oper-T" name='oper-T' class="neirong" >	
	<div class="top">
	<div class="top_01">
	...
	<div class="top02right"><img src="style/images/public/toptiaoright.gif" /></div>	
		...
		<form id='operform' name="operform" onsubmit="return false;" action="#" >
			<table width="100%" id="tdiv" border="0" cellspacing="0" cellpadding="0" style="line-height:33px; font-size:12px;">
				 <tr>			    
				 	<!-- 表别名 -->
				    <td width="20%" align="right"  class="labelclass"><label id=''><fmt:message key="menuManager.tablealias" /></label></td>
			    	<td width="30%" align="left" style="border-bottom:1px solid #A9C8D9;">
			    		<input type="text" name="tablealiasName" id="tablealiasName" maxlength='20' class="textclass" />
			 	 ...
			 	 <tr>
			 	 	<!-- 表名 -->
				    <td width="20%" align="right"  class="labelclass"><label id=''><fmt:message key="menuManager.tablename" /></label></td>
				    <td width="30%" align="left" style="border-bottom:1px solid #A9C8D9;">
				    	<input type="text" name="tableName" id="tableName" maxlength="50" class="textclass" style="width:166px" ></input>
				    	<!-- 设置显示字段 -->
