		...
		<script type="text/javascript">
			...
			function getPriParams_query(){
			 	...
			 	*/
			 	...
			 	var res = fetchMultiArrayValue("dbsql_phone.querytabledate",6,"&tablename=yhdang y,hthdang h&cloum=h.hth,h.yhmc,y.yhmc&key=y.hth=h.hth and y.dh='"+Dh+"'");
			 	if(res[0]==undefined || res[0][0]==undefined)
        		{
...
<body >
		...
		<table>
			  			<tr>
							...
							<td  align="left" >
								<select id="zhangQi1"  style="width: 145px;" onchange="zqchange()"></select><font style="color:red;">*</font>
							</td>
							<td width="10%" align="right" >
													<label id="time1g">话始时间从</label>
							</td>
							<td  align="left" >
									<input type="text" name="time1"    id="time1" value="01 00:00:00"
		  ...
		  <table>
			<tr>	
		  		<td>
		  			<table id="listQtb" cellspacing="2px;" cellpadding="0" style="border: 0px;">				
						<tr>
							<td width="12%" align="right" >
								<!-- <label id="time1g">
									
									<select id="htdh"  style="width: 60px;">
										<option value="dhh">电话号</option>
										<option value="hth">合同号</option>
									</select>
								</label>
							</td>
							<td width="22%" align="left" >
								<input type="text" name="Dh" id="Dh" ></input><font style="color:red;">*</font>		
																 
								<input type="text" name="Dh" id="Dh" style="ime-mode: Disabled" onkeypress="var k=event.keyCode; return k>=48&&k<=57" maxlength="8" onpaste="return   !clipboardData.getData('text').match(/\D/)" ondragenter="return false"
								/>		
								 -->
										<label id="DHHM">电话号码</label>						
							</td>
							<td>
										<input type="text" id="Dhhm"/>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td width="22%" align="left" >
									<input type="text" name="Bjhm" id="Bjhm" style="ime-mode: Disabled" onkeypress="var k=event.keyCode; return k>=48&&k<=57" maxlength="8" onpaste="return   !clipboardData.getData('text').match(/\D/)" ondragenter="return false"
									></input>
							</td>
						</tr>
					 </table>
		  		...
		  		<td>
		  			&nbsp;&nbsp;&nbsp;&nbsp;呼叫类型：
		  			<div id="thedeptm1" style="width:380px; height: 50px;background-color: #F8F8FF;overflow-y: scroll; overflow-x: hidden; border-top: 1px solid gray; border-left: 1px solid gray;"></div>
		  		</td>
		  		<td valign="bottom">
		...
		<div id='QCeng' >
			...
			<div id="buttons">
				...
				<button type="button" id="resortId" onclick="resortBill()" disabled="disabled">					
					重新分拣
				</button>
			</div>
			<div id="gridd">
