...
<title>WEB查询系统--合同号查询--修改密码</title>
...
<body>
	<div>
		<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
			value="/wEPDwUIMjA4MDY1NTZkGAEFHl9fQ29udHJvbHNSZXF1aXJlUG9zdEJhY2tLZXlfXxYBBQVidG5PS8Qa+QF81y1LB7IEr/U4QRtYJtDy" />
	</div>
			...
			<td height="40">
				<table cellSpacing=0 cellPadding=0 width="100%" bgcolor=#336699
					...
					<tbody>
						...
						<tr>
							<td vAlign=top><table id=header1 cellSpacing=0 cellPadding=0
									width="100%" border=0>
									<TBODY>
				...
				<div align="center">
					<span id="MenuControl1">
						<table width="160" height="100%" border=0 cellpadding=0
							cellspacing=0 align="center" background-color=Color[Empty]>  <tr>
					         ...
					         <td valign="top"><table> 
					          <tr align="left" style="display:none">  	
					           <td style="height:2px; width:160px; background-image:url(images/bar2.gif); background-repeat:repeat"></td> 
					            <tr align="left" style="display:none">  	
					             <td height="40" width="160" align="left" class="P" onmouseover="MO()" onmouseout="MU()" 	 		onclick="javascript:location.href='AccountDetail.jsp'"><img src="images/list.gif" width="12" height="12" align="absMiddle"> 
					             合同号详单</td> 	
					              ...
					              <td style="height:2px; width:160px; background-image:url(images/bar2.gif); background-repeat:repeat">
					               	 ...
					               	 <td height="40" width="160" align="left" class="P"><img src="images/list.gif" width="12" height="12" align="absMiddle"> 
					               	<a href="AccountFee.jsp">合同号话费</a></td> 	</tr>  <tr align="left" style="display:auto">  
					               	 	 <td style="height:2px; width:160px; background-image:url(images/bar2.gif); background-repeat:repeat"></td> 
					               	 	  <tr align="left" style="display:auto">  	
					               	 	   <td height="40" width="160" align="left" class="P"><img src="images/list.gif" width="12" height="12" align="absMiddle"> 
					               	 	 <a href="AccountDFee.jsp">合同号话费明细</a></td> 	</tr>  <tr align="left" style="display:auto">  
					               	 	   	 <td style="height:2px; width:160px; background-image:url(images/bar2.gif); background-repeat:repeat"></td>  <tr align="left" style="display:auto">  	
					               	 	   	  <td height="40" width="160" align="left" class="Q" ><img src="images/list.gif" width="12" height="12" align="absMiddle"> 
					               	 	   	  <a href="AccountPassword.jsp">合同号修改密码</a></td> 	</tr>
					               	 	   	    <tr align="left" style="display:auto">  
					               	 	   	  	 <td style="height:2px; width:160px; background-image:url(images/bar2.gif); background-repeat:repeat"></td> </table></td> <td style="width:1px;background-image:url(images/bar.gif); background-repeat:repeat"></td></tr></table>
		</span>
					    </div>
					</td>	
												...
												<tr>
													<td style="PADDING-RIGHT:10pt; PADDING-LEFT:10pt; PADDING-BOTTOM:10pt; PADDING-TOP:10pt;
														...
														<table cellpadding="0" cellspacing="4" class="css0113">
															<tr>
																<td class="css0059" align="right"><label for="txtUserId">合同号：</label></td>
													...
													<td class="css0144" style="height:20px;PADDING-RIGHT:5pt; PADDING-LEFT:5pt; PADDING-BOTTOM:5pt; PADDING-TOP:5pt; background-color: background;">
														<table cellpadding="0" cellspacing="4" class="css0113">																														
															<tr>
																...
																<td class="css0093" style="width: 105px"><div align="left"><span class="css0170"><input type="image" name="btnOK" id="btnOK" src="images/a_ok.gif" style="border-width:0px;" onclick="btnOK()"/></span></div>																
                                                                        </td>
															</tr>
	...
	<div>
		...
		<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION"
			value="/wEWBgK+m/fMCAKL+4qxCwKE+47GCwKL+96gBALzp9GUDQLdkpmPAfnUIvPMj1eglHE+jQlxFEO08f2a" />
	</div>
	<script src="js/jquery-3.1.1.min.js"></script>
	<script language="javascript" src="js/dialog.js" type="text/javascript"
