...
<body>
	<div>
		<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
			value="/wEPDwUJMzc0OTAxODg5ZGTOWSHn+t1iQnIqgm4u4IkgsuC1Eg==" />
	</div>
				...
				<div>
					<span id="MenuControl1">
						<table width="160" height="100%" border=0 cellpadding=0
							cellspacing=0 align="center" background-color=Color[Empty]>
					      <tr> 
					      <td style="width:1px;background-image:url(images/bar.gif); background-repeat:repeat">
					      	 ...
					      	 <td height="40" width="160" align="left" class="P" onmouseover="mousemove(this)" onmouseout="mouseup(this)" onclick="javascript:location.href='AccountDetail.jsp'">
