	...
	<div class="navbar navbar-default" id="navbar">
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-right" role="navigation">
				<ul class="ace-nav">
					<li><span class="white"><label id="admin_wsi_status">&nbsp;</label></span>
						<span class="white">欢迎光临，${session.userInfo.userName}></span> <a
						id="modifypsw_admin" data-toggle="modal" data-target="#password"
						href=""> 更改密码 </a> <a id="logout" href="#"> 退出 </a></li>
				</ul>
				<!-- /.ace-nav -->
			</div>
			<!-- /.navbar-header -->
	...
	<div class="main-container" id="main-container">
		<div class="main-container-inner">
			...
			<div class="main-content">
				<iframe id="rightFarme" name="right" width="100%" height="100%"
					src="" frameborder="no" scrolling="yes" allowtransparency="true">
				</iframe>
	...
	<div class="modal fade" id="password" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<input type="hidden" id="modleuserId"> <input type="hidden"
					id="flag">
					...
					<table class="modal-table" cellspacing="0" cellpadding="0"
						...
						<tbody>
							<tr rowpos="1" class="FormData" id="">
								<td class="CaptionTD">原始密码</td>
								<td class="DataTD"><input type="password" id="oldPw"
									class=""></td>
							</tr>

							<tr rowpos="2" class="FormData" id="">
								<td class="CaptionTD">新密码</td>
								<td class="DataTD"><input type="password" id="newPw1"
									class=""></td>

							</tr>
							<tr rowpos="3" class="FormData" id="tr_note">
								<td class="CaptionTD">确认新密码</td>
								<td class="DataTD"><input type="password" id="newPw2"
									class=""></td>
							</tr>
						</tbody>
					</table>
