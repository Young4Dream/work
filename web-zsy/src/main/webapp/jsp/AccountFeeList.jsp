...
<html>
<head>
<title>WEB查询系统--合同号查询--合同号话费--列表</title>
...
<body>
	<form name="form2" method="post"
		action="AccountFeeList.jsp?Account=573&amp;Begin=201611&amp;End=201611"
		id="form2">
		<div>
		...
		<table style="background-color: #4791c5" width="100%" border="0"
			...
			<tr>
				<td style="height: 500px; width: 98px;" valign="top">
								...
								<td style="PADDING-TOP: 5pt;" valign="top" width="100%"
									...
									<div align="center">
										<table cellspacing="0" cellpadding="0" width="800"
											...
											<tr>
												<td height="30"><span id="lblStat"
													style="font-weight: bold;"> 合同号[ 573 ]；开始月份[ 201611
														]；结束月份[ 201611 ] </span>&nbsp;</td>
												<td height="30" align="right"><span id="lblSum"
										...
										<table cellspacing="0" cellpadding="0" width="800"
											...
											<tr valign="top">
												<td valign="top" style="height: 455px">&nbsp;</td>
											</tr>
										</table>
										...
										网联移+铁电=详单的市话,网联移表示优惠的市话,而铁电是不享受优惠的市话.</span>
								</td>
		...
		<div>
			...
			<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION"
				value="/wEWFQKugtLlCgLo442vBQKAg4OnDwKBg4OnDwKCg4OnDwKDg4OnDwL8goOnDwL9goOnDwL+goOnDwL/goOnDwL4goOnDwL5goOnDwKAg5eCCAKBg5eCCAKCg5eCCAKO+N3hDwLWs7u7BwK14fOOCgKx4bePCQK9r9qICQKBk/m1C2ZDKZj2oH70Ure+OmVT5VVWdgCs" />
		</div>
	</form>
</body>
</html>
